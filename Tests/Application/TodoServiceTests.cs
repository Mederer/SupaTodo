...
public class TodoServiceTests
{
    ...
    void GetAllTodos_ShouldReturnList_WhenTodosExist()
    {
        _todoRepositoryMock.Setup(x => x.FindAll()).Returns(new List<Todo>()
        {
            new Todo
            {
                Id = Guid.NewGuid(), Title = "Test Todo 1", CreatedAt = DateTime.Now, IsComplete = true,
                LastModified = DateTime.Now
            },
            new Todo
            {
                Id = Guid.NewGuid(), Title = "Test Todo 2", CreatedAt = DateTime.Now, IsComplete = false,
                LastModified = DateTime.Now
            },
            new Todo
            {
                Id = Guid.NewGuid(), Title = "Test Todo 3", CreatedAt = DateTime.Now, IsComplete = true,
                LastModified = DateTime.Now
            },
        });
